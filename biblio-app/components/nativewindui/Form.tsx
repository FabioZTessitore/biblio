  ...
  (
    ...
    return (
      <View
        ...
        className={cn(
          'relative',
          Platform.OS !== 'ios' && !!iconProps && 'flex-row gap-4',
          rootClassName
        )}>
        ...
        {!!iconProps && (
          <View className="ios:hidden pt-3">
            <Icon color={colors.grey} size={24} {...iconProps} />
          </View>
        )}
        <View className="flex-1">
          ...
          {!!footnote && (
            <Text
              className={cn('ios:pl-3 ios:pt-1 pl-3 pt-1 text-muted-foreground', footnoteClassName)}
              variant="label">
              {footnote}
            </Text>
          )}
